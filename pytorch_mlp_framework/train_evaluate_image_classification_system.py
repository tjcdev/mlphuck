...
from pytorch_mlp_framework.convolutional_blocks import *
...
''' Data augmentation strategies to improve generalisation of the model'''

transform_train = transforms.Compose([
        transforms.RandomCrop(32, padding=4),
        transforms.RandomHorizontalFlip(),
        transforms.ColorJitter(contrast=(0.01,0.7), brightness=(0.01,0.7)),
        transforms.ToTensor(),
...
''' reads from command-line to choose which processing and dim reduction
blocks will be used.'''
...
elif args.block_type == 'conv_block_s1':
    processing_block_type = ConvProcessingBlockResnet
    dim_reduction_block_type = ConvDimensionalityReductionBlockResnet    
elif args.block_type == 'conv_block_s2':
    processing_block_type = ConvProcessingBlockBNNetwork
    dim_reduction_block_type = ConvDimensionalityReductionBlockBNNetwork  
